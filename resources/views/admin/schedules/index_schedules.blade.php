...
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <!--center>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#horario_especialidad" data-whatever="@mdo">Crear Horario para Especialidad de Medico</button>
                </center-->
            </div>
            <div class="col-md-6">
                <center>
                    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Agregar Nuevo Horario</button>
                </center>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="horario_especialidad" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="exampleModalLabel">Crear Horario para Especilidad de Medico <label for=""></label></h4>
        </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <label for="">Seleccione un Medico con su Especialidad</label> <br>
                                <small class="text-red" id=""></small>
                                <!--input name="nombre_horario" class="form-control name_form" type="text" value=""-->
                                <select class="select2_group form-control name_form" name="">
                                    @forelse($espe_medico as $es)
                                        <option value="">{{ $es->name}} {{ $es->apellidos }} -- Especialidad en: {{ $es->nombre_especialidad }}</option>
                                    @empty
                                    @endforelse
                                </select>
                        </div>
        ...
        <div class="modal-body">
            ...
            <form class="sendform_schedules" action="{{url('create_schedules')}}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="">Tipo Horario</label> <br>
                                <small class="text-red" id=""></small>
                                <select class="select2_group form-control name_form" name="tipo_horario">
                                    <option value="0">Horario Normal</option>
                                    <option value="1">Para Especialidad</option>
                                </select>
                        </div>
                    </div>
                </div>

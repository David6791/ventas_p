...
<div class="row">
    <div class="col-md-6 col-sm-6">
        {{ $lista->name }} {{ $lista->apellidos }} 
    </div>
    <div class="col-md-3 col-sm-3">
        {{ $lista->name_schedules }}
    </div>
    <div class="col-md-3 col-sm-3">
        <button class="btn btn-primary btn-xs load_date_medic" name="id_assignments" value="{{$lista->id_medical_assignments}}">Seleccionar</button>
    </div>      
</div>
@endforeach

<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="box-body">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class=""><a href="#tab_content5" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Examen Medico</a>
                    </li>
                    <li role="presentation" class=""><a href="#tab_content6" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Traslado de Paciente</a>
                    </li>
                    <li role="presentation" class=""><a href="#tab_content7" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Finalizar Cita Medica</a>
                    </li>
                </ul>
    ...
    <div role="tabpanel" class="tab-pane fade" id="tab_content7" aria-labelledby="">
        <div class="row">
            <div class="x_panel">
                <div class="x_content">
                    <div class="col-md-12">
                        <div class="center-block">
                            <h1 class="text-red">DESEA TERMINAR LA CONSULTA MEDICA...?</h1>
                            <button type="button" class="btn btn-danger end_medical_appointments" value="{{ $dates_cita_end[0]->id_medical_appointments }}">Finalizar Cita Medica</button>
                        </div>
                    </div>
                </div>
            </div>

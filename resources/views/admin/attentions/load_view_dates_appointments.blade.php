...
<div class="row">
	<div class="col-md-6">
		<center>
			<div class="box-header">
				<h3 class="box-title text-green">NOTAS MEDICAS</h3>
			</div>
		</center>
		<div class="row">
			<div class="col-md-12">
	...
	<div class="col-md-6">
		<center>
			<div class="box-header">
				<h3 class="box-title text-green">TRATAMIENTO</h3>
			</div>
		</center>
		<div class="row">
			@if(isset($treat))
			No existen TRATAMIENTO
			@else
			<div class="x_panel">
				<div class="row">
					<div class="col-md-12">
...
<div class="row">
	<div class="col-md-6">
		<center>
			<div class="box-header">
				<h3 class="box-title text-green">EXAMEN MEDICO</h3>
			</div>
		</center>
		<div class="row">
			<div class="col-md-12">
	...
	<div class="col-md-6">
		<center>
			<div class="box-header">
				<h3 class="box-title text-green">TRASLADO PACIENTE</h3>
			</div>
		</center>
		<div class="row">
			<div class="col-md-12">
                ...
                @empty
                    NO EXISTEN REGISTROS DE TRASLADO
				@endforelse
			</div>
		</div>
	</div>

                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ci" required="required" class="form-control col-md-7 col-xs-12 name_form" placeholder="Ingrese numero de Documento">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <small class="text-red" id=""></small>
                                    <input type="email" class="form-control col-md-7 col-xs-12 name_form" placeholder="Ingrese Nombre de Usuario o Email" name="email">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <small class="text-red" id=""></small>
                                    <input type="text" class="form-control col-md-7 col-xs-12 name_form" placeholder="" name="matricula">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <small class="text-red" id=""></small>
                                    <input type="text" class="form-control col-md-7 col-xs-12 name_form" placeholder="" name="egreso">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <small class="text-red" id=""></small>
                                    <input type="text" class="form-control col-md-7 col-xs-12 name_form" placeholder="" name="año_egreso">
                                </div>
                            </div>
                        </div>
                        <div class="box-header with-border">
